...
@IBDesignable open class CardGroupSliding: CardGroup {
    ...
    fileprivate var layoutt = UICollectionViewFlowLayout()
    ...
    override  func initialize() {
        ...
        slidingCV = UICollectionView(frame: CGRect.zero, collectionViewLayout: layoutt)
...
extension CardGroupSliding: UICollectionViewDelegateFlowLayout{
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        iconsSize = collectionView.frame.height/3 - layoutt.minimumLineSpacing
